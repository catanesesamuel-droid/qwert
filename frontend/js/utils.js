...
async function postData(url, data) {
    try {
        ...
        if (isAuthEndpoint) {
            // Para el endpoint de login, enviar como form-urlencoded
 ...
 * En Paso 3, el token está en cookie HttpOnly (no en sessionStorage)
 ...
 * Llama al backend para eliminar cookies y limpia sessionStorage
 */
